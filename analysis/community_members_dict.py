...
"""
Created on Thu Jan  4 11:06:08 2024
...
###
# community members in MC
for c in cs_sorted_fba_mc:
    d_community_members[c] = mym.community_members(d_misosoup, c, "min")


###
# community members in MSC
for c in cs_sorted_fba_msc:
    d_community_members[c] = {}
    for s in all_species:
        d_community_members[c][s] = mym.community_members(d_misosoup, c, s)
...
with open(
    ...
    documents = yaml.dump(d_community_members, file)
